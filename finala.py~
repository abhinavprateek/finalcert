...
#this will define the ELEMENTS that will compose the template. 
	elements = [
		...
		{ 'name': 'name', 'type': 'T', 'x1': 83, 'y1': 55, 'x2': 150, 'y2': 64, 'font': 'Times', 'size': 18.0, 'bold': 1, 'italic': 0, 'underline': 0, 'foreground': 0, 'background': 0, 'align': 'C', 'text': '', 'priority': 3, },
		{ 'name': 'course', 'type': 'T', 'x1': 113, 'y1': 68, 'x2': 150, 'y2': 74, 'font': 'Times', 'size': 18.0, 'bold': 1, 'italic': 0, 'underline': 0, 'foreground': 0, 'background': 0, 'align': 'C', 'text': '', 'priority': 3, },
